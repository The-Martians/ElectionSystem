        ...
        <div class="col-md-4 margin-top-20">
            <div class="row">
                <div class="panel panel-default">
                    <div class="panel-heading">Login Student</div>
                    <div class="panel-body">
                        {!! Form::open(array('action' => 'User\AuthController@loginPost')) !!}
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                {!! Form::text('stuid',$value = null ,$attributes = ['class' => 'form-control' , 'placeholder' => 'Your ID address']) !!}
                            </div>
